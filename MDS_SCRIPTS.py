...
class Dataset:
    """Loads and preprocesses the KARA ONE database.

    This class provides means for easily automated preproccessing and preparation of the KARA ONE dataset. 
    Most of the data is kept within the class. Only two methods (prepare_data() and find_best_features()) are not void.
    ...
    def __init__(self, subject):
        self.name = subject
        self.dataPath = None
        self.registry.append(self) # TODO is self in self.registry neccesary
    ...
    def load_data(self, path_to_data, raw=False, filtered=False):
        ...
        path_to_data : str
            ...
            For a single subject the folder structure should resemble ...\\path_to_data\\MM05\\
        raw : bool
        ...
        if raw:
            ...
            self.dataPath = os.path.join(path_to_data, self.name)
            os.chdir(self.dataPath)
